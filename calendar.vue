		...
		<view v-if="!insert&&show" class="uni-calendar__mask" :class="{'uni-calendar--mask-show':aniMaskShow}"
			...
			<view class="uni-calendar__box">
				...
				<view class="uni-calendar__weeks">
					<view class="uni-calendar__weeks-day"  v-for="(item,index) in weeksList" :key="index+'week'">
						<text class="uni-calendar__weeks-day-text">{{item}}</text>
					</view>
				</view>
				<view class="uni-calendar__weeks" v-for="(item,weekIndex) in weeks" :key="weekIndex" @click="!btnFlg && confirm()">
			...
			<view v-if="btnFlg" class="uni-date-changed uni-calendar__header" @click="confirm">
				<view class="uni-calendar__header-btn-box">
					<text class="uni-calendar__button-text uni-calendar--fixed-width">Ok</text>
				</view>
			</view>
		</view>
	</view>
...
<script>
	...
	import {langePack} from './lange.js';
	 ...
	 * @example <uni-calendar :insert="true":lunar="true" :start-date="'2019-3-2'":end-date="'2019-5-20'"@change="change" />
	 --------------------------------------------------------------------------
	   @btnFlg  true 按钮选择或 false日期直接选择
	   @filterData 新增 需要标记的日期 格式 ['2021-03-05','2021-03-05']
	   @lang  语种 支持 cn 中午 en 英文
	 */
	export default {
		components: {
			calendarItem,
		...
		methods: {
			 ...
			 */
			init(date) {
				this.weeksList =  langePack[this.lang]
